    ...
    useEffect(() => {
        ...
        const fetchStats = async () => {
            ...
            await Promise.all(repos.map(async (repo) => {
                ...
                try {
                    // Optimized fetch: Use getRepositoryStats to save API calls
                    // (1 Core call + 1 Search call instead of 2 Search calls)
